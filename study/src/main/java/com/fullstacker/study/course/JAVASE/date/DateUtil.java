...
public final class DateUtil {
    ...
    public static long minutesLeftTo(Date fromDate, Date toDate) {
        return fromDate != null && toDate != null ? (toDate.getTime() - fromDate.getTime()) / MILLISECONDS_IN_MINUTE
                : 0L;
    }
    ...
    public static Double daysLeftTo(Date toDate) {
        ...
        try {
            days = Double.valueOf(Long.valueOf(toDate.getTime() - d.parse(nowtime).getTime()).doubleValue()
    ...
    public static Long calMinutesPassed(Date from) {
        return from == null ? Long.valueOf(0L)
                : Long.valueOf(((new Date()).getTime() - from.getTime()) / MILLISECONDS_IN_MINUTE);
    }
    ...
    static {
        SECONDS_IN_YEAR = Long.valueOf(
                SECONDS_IN_MINUTE.longValue() * MINUTES_IN_HOUR.longValue() * HOURS_IN_DAY.longValue() * DAYS_IN_YEAR
                        .longValue());
        SECONDS_IN_MONTH = Long.valueOf(
                SECONDS_IN_MINUTE.longValue() * MINUTES_IN_HOUR.longValue() * HOURS_IN_DAY.longValue() * DAYS_IN_MONTH
                        .longValue());
        SECONDS_IN_WEEK = Long.valueOf(
                SECONDS_IN_MINUTE.longValue() * MINUTES_IN_HOUR.longValue() * HOURS_IN_DAY.longValue() * DAYS_IN_WEEK
                        .longValue());
    ...
    public static void main(String[] args) throws ParseException {
        ...
        LocalDateTime start = cn.hutool.core.date.DateUtil.parseLocalDateTime("202202", DatePattern.PURE_DATE_PATTERN);
